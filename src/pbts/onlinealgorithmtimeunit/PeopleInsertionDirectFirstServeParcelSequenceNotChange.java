...
import java.io.*;
public class PeopleInsertionDirectFirstServeParcelSequenceNotChange implements
		OnlinePeopleInsertion {

	public SimulatorTimeUnit sim;
	public PrintWriter log;
	public PeopleInsertionDirectFirstServeParcelSequenceNotChange(SimulatorTimeUnit sim){
		this.sim = sim;
		this.log = sim.log;
	}
	public String name(){
		return "PeopleInsertionDirectFirstServeParcelSequenceNotChange";
	}
