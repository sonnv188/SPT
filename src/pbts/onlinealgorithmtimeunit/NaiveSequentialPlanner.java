...
public class NaiveSequentialPlanner implements OnlinePlanner {
	...
	public NaiveSequentialPlanner(SimulatorTimeUnit sim){
		this.sim = sim;
		this.log = sim.log;
		peopleInserter = new PeopleInsertionDirectFirstServeParcelSequenceNotChange(sim);
		parcelInserter = new ParcelInsertionLastSequenceNotChange(sim);
	}
	...
	public String name(){ return "NaiveSequentialPlanner";}
