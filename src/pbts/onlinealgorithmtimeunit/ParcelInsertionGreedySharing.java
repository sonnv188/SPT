...
public class ParcelInsertionGreedySharing implements OnlineParcelInsertion {

	public SimulatorTimeUnit sim;
	public PrintWriter log;
	public SequenceOptimizer seqOptimizer = null;
	
	public ParcelInsertionGreedySharing(SimulatorTimeUnit sim){
		this.sim = sim;
		this.log = sim.log;
		seqOptimizer = new SequenceOptimizer(sim, sim.maxPendingStops + 10);		
	}
	public String name(){ return "ParcelInsertionGreedySharing";}
