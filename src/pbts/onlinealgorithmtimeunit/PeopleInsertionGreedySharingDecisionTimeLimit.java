...
public class PeopleInsertionGreedySharingDecisionTimeLimit implements
	...
	public PeopleInsertionGreedySharingDecisionTimeLimit(SimulatorTimeUnit sim){
		this.sim = sim;
		this.log = sim.log;
		seqOptimizer = new SequenceOptimizer(sim, sim.maxPendingStops + 10);
	}
	public String name(){
		return "PeopleInsertionGreedySharingDecisionTimeLimit";
	}
