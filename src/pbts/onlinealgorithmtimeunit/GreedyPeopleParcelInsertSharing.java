...
public class GreedyPeopleParcelInsertSharing implements OnlinePlanner {
	...
	public GreedyPeopleParcelInsertSharing(SimulatorTimeUnit sim){
		this.sim = sim;
	...
	public String name(){ return "GreedyPeopleParcelInsertSharing";}
